...
const HeroServer = async () => {
  ...
  try {
    data = await client.fetch<HeroData>(
      heroQuery,
      {},
      {
    ...
    <div className="relative bg-gray-900 text-white h-screen">
      <div className="absolute inset-0">
        <Image
          ...
          src={
            hasImageAsset(data.backgroundImage)
      ...
      <div
        className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center h-full flex flex-col justify-center items-center"
        role="region"
