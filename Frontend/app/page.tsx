...
export default function HomePage() {
  ...
  const [heroData, setHeroData] = useState<HeroData | null>(null); // Hero verisi için yeni state
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setHeroData(hero); // Gelen hero verisini state'e kaydediyoruz
    };
    fetchData();
  }, []); 
  ...
  return (
      ...
      {/* İlanlar bölümüne bir id ekliyoruz ve üstten boşluk veriyoruz */}
      <main id="ilanlar" className="container mx-auto p-4 md:p-8 bg-gray-50 min-h-screen font-roboto font-light">
