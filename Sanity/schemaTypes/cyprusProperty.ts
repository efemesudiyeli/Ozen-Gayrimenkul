...
export default defineType({
  ...
  preview: {
    ...
    prepare(selection) {
      ...
      return {
        title: title,
        subtitle: `Kıbrıs İlan No: ${subtitle || '...'}${inactiveSuffix}`,
        media: media,
      };
    },
  },
